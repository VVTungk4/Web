    ...
    if ($result->num_rows > 0) {
        while($row=$result->fetch_assoc()) {
            ...
            $quantity = $result1->fetch_assoc()['quantity'];
                ...
                $row['sizename']."</td><td width='10%' class='text-center'>Còn: ".$quantity."</td><td width='10%' class='text-center'><button onclick='themsanphamvaodonhang(this)' id='btntable' class='btn btn-outline-danger' style='color:var(--orange);'>Thêm Vào Đơn</button></td></tr>";
                $stt++;
